...
const numberEntryCard = () => `
        <div
            class="flex flex-col w-full h-40 bg-white rounded-lg text-2xl font-bold justify-center items-center text-green-500 hover:bg-green-500 hover:text-white cursor-pointer relative md:text-4xl lg:text-5xl"
            >
